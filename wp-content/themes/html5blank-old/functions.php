...
function underscore_widgets_init() {
    ...
    /*Sidebar footer*/
    register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Footer', 'underscore' ),
		'id'            => 'sidebar-footer',
		'description'   => esc_html__( 'Add widgets here.', 'underscore' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
    ...
    /*Sidebar Services*/
    register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Services', 'underscore' ),
		'id'            => 'sidebar-services',
		'description'   => esc_html__( 'Add widgets here.', 'underscore' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
    ...
    /*Sidebar Locations*/
    register_sidebar( array(
		'name'          => esc_html__( 'Sidebar Locations', 'underscore' ),
...
//removing the mobile nav wp_enqueue_script( 'underscore-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
...
function enqueue_load_fas() {
wp_enqueue_style( 'load-fas', 'https://use.fontawesome.com/releases/v5.0.10/css/all.css' );
}
add_action( 'wp_enqueue_scripts', 'enqueue_load_fas');

function enqueue_load_fab() {
wp_enqueue_style( 'load-fab', 'https://use.fontawesome.com/releases/v5.0.10/css/all.css' );
}
add_action( 'wp_enqueue_scripts', 'enqueue_load_fab');
